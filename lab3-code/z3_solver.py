...
# raise NotImplementedError('TODO: Your code here!')
f3 = And(And(Or(p, q), And(q, r), And(p, Not(r))))
pretty_print(f3)
solve(f3)
...
pretty_print('---------------')
solve(f1_5)
f1_5 = And(f1_5, Not(And(And(p, q), Not(r))))
solve(f1_5)
f1_5 = And(f1_5, Not(And(Not(p), Not(q)), r))
solve(f1_5)
f1_5 = And(f1_5, Not(And(And(p, Not(q)), r)))
solve(f1_5)
f1_5 = And(f1_5, Not(And(And(Not(p), q), r)))
solve(f1_5)
f1_5 = And(f1_5, Not(And(And(p, q), r)))
solve(f1_5)
